...
// Zmiana: dodanie strumienia, dla czytelności kodu


public class Gradebook {
    // Zmiana: Usunąłem listę subjects, ponieważ nazwy przedmiotów są już kluczami w mapie subjectsGrades.
    // Przechowywanie tego samego w dwóch miejscach prowadzi do błędów synchronizacji danych (tzw. redundancja).
    ...
    public void addSubject(String subject) {
        // Zmiana: Dodano sprawdzenie, czy przedmiot już istnieje, aby nie nadpisać listy ocen nową, pustą listą.
    ...
    public void addGrade(String subject, double grade) {
        if (subjectsGrades.containsKey(subject)) {
            ...
            // Wcześniej kod blokował dodawanie ocen z historii bez żadnego komunikatu, co było błędem logicznym.
    ...
    public double calcAvgForSubject(String subject) {
        if (subjectsGrades.containsKey(subject)) {
            ...
            // Zmiana: Zamiast rzucać wyjątek przy braku ocen, lepiej zwrócić 0.0 lub poinformować o tym inaczej.
            // Rzucanie błędu przy pustej liście często psuje działanie pętli obliczających średnią dla wszystkich.
            if (grades.isEmpty()) {
                return 0.0;
            }
