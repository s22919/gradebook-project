...
public class GradebookTest {
  ...
  public void testAverageForSubjectWithNoGrades() {
    ...
    assertTrue(
        averages.containsKey("EmptySubject"), "Mapa powinna zawierać przedmiot nawet bez ocen");
    assertEquals(
        0.0,
        averages.get("EmptySubject"),
        0.001,
        "Średnia dla przedmiotu bez ocen powinna wynosić 0.0");
  }
  ...
  public void testAddDuplicateSubjectDoesNotClearGrades() {
    ...
    assertEquals(
        1, mathGrades.size(), "Ponowne dodanie przedmiotu nie powinno czyścić listy jego ocen");
